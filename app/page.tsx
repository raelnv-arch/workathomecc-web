          ...
          {isMobileMenuOpen && (
            ...
            >
              <div className="px-4 py-6 pt-12 space-y-4 flex flex-col font-heading font-semibold text-sm uppercase tracking-wide items-center w-full">
                <a onClick={(e) => { e.preventDefault(); setIsMobileMenuOpen(false); document.getElementById('about')?.scrollIntoView({ behavior: 'smooth' }); }} href="#about" className="block text-blue-100 w-full text-center hover:text-white hover:bg-[#1a4a8c] px-4 py-3 rounded-lg transition">About</a>
                <a onClick={(e) => { e.preventDefault(); setIsMobileMenuOpen(false); document.getElementById('focus')?.scrollIntoView({ behavior: 'smooth' }); }} href="#focus" className="block text-blue-100 w-full text-center hover:text-white hover:bg-[#1a4a8c] px-4 py-3 rounded-lg transition">Focus</a>
                <a onClick={(e) => { e.preventDefault(); setIsMobileMenuOpen(false); document.getElementById('services')?.scrollIntoView({ behavior: 'smooth' }); }} href="#services" className="block text-blue-100 w-full text-center hover:text-white hover:bg-[#1a4a8c] px-4 py-3 rounded-lg transition">Services</a>
                <a onClick={(e) => { e.preventDefault(); setIsMobileMenuOpen(false); document.getElementById('team')?.scrollIntoView({ behavior: 'smooth' }); }} href="#team" className="block text-blue-100 w-full text-center hover:text-white hover:bg-[#1a4a8c] px-4 py-3 rounded-lg transition">Team</a>
                <a onClick={(e) => { e.preventDefault(); setIsMobileMenuOpen(false); document.getElementById('contact')?.scrollIntoView({ behavior: 'smooth' }); }} href="#contact" className="block text-blue-100 w-full text-center hover:text-white hover:bg-[#1a4a8c] px-4 py-3 rounded-lg transition">Contact</a>
                ...
                <a onClick={(e) => { e.preventDefault(); setIsMobileMenuOpen(false); document.getElementById('contact')?.scrollIntoView({ behavior: 'smooth' }); }} href="#contact" className="mt-4 block w-full text-center px-6 py-4 border border-transparent text-sm font-bold rounded-lg text-[#051124] bg-gradient-to-r from-[#4caf50] to-[#3d8c40] hover:from-[#5cdb61] hover:to-[#4caf50] shadow-[0_0_15px_rgba(76,175,80,0.3)]">
                  Partner With Us
                </a>
              </div>
            </motion.div>

...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-slate-50 text-slate-800 antialiased font-sans">
      ...
      <nav className="bg-[#0f346c] shadow-lg fixed w-full z-50 overflow-visible">
        <div id="nav-container" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="flex justify-end md:justify-between h-20 items-center w-full">
            ...
            <div className="hidden md:flex items-center space-x-4 lg:space-x-8 font-heading font-semibold text-xs lg:text-sm uppercase tracking-wide">
          ...
          {isMobileMenuOpen && (
            ...
            >
              <div className="px-4 py-6 pt-12 space-y-4 flex flex-col font-heading font-semibold text-sm uppercase tracking-wide items-center w-full">
                ...
                <a onClick={(e) => { e.preventDefault(); setIsMobileMenuOpen(false); setTimeout(() => document.getElementById('focus')?.scrollIntoView({ behavior: 'smooth' }), 300); }} href="#focus" className="block text-blue-100 w-full text-center hover:text-white hover:bg-[#1a4a8c] px-4 py-3 rounded-lg transition">Focus</a>
                <a onClick={(e) => { e.preventDefault(); setIsMobileMenuOpen(false); setTimeout(() => document.getElementById('services')?.scrollIntoView({ behavior: 'smooth' }), 300); }} href="#services" className="block text-blue-100 w-full text-center hover:text-white hover:bg-[#1a4a8c] px-4 py-3 rounded-lg transition">Services</a>
                <a onClick={(e) => { e.preventDefault(); setIsMobileMenuOpen(false); setTimeout(() => document.getElementById('team')?.scrollIntoView({ behavior: 'smooth' }), 300); }} href="#team" className="block text-blue-100 w-full text-center hover:text-white hover:bg-[#1a4a8c] px-4 py-3 rounded-lg transition">Team</a>
                <a onClick={(e) => { e.preventDefault(); setIsMobileMenuOpen(false); setTimeout(() => document.getElementById('contact')?.scrollIntoView({ behavior: 'smooth' }), 300); }} href="#contact" className="block text-blue-100 w-full text-center hover:text-white hover:bg-[#1a4a8c] px-4 py-3 rounded-lg transition">Contact</a>
                ...
                <a onClick={(e) => { e.preventDefault(); setIsMobileMenuOpen(false); setTimeout(() => document.getElementById('contact')?.scrollIntoView({ behavior: 'smooth' }), 300); }} href="#contact" className="mt-4 block w-full text-center px-6 py-4 border border-transparent text-sm font-bold rounded-lg text-[#051124] bg-gradient-to-r from-[#4caf50] to-[#3d8c40] hover:from-[#5cdb61] hover:to-[#4caf50] shadow-[0_0_15px_rgba(76,175,80,0.3)]">
                  Partner With Us
                </a>
              </div>
            </motion.div>
      ...
      {/* Focus Section (Built For Success & Video Embed) */}
      ...
      <footer className="bg-[#0f346c] text-white py-16 border-t-[10px] border-[#4caf50]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-blue-200 text-sm">
              <li className="flex items-start"><svg className="w-5 h-5 mt-0.5 mr-3 text-[#4caf50] shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg> 30 N Gould St, Ste R<br />Sheridan, WY 82801</li>
              <li className="flex items-center"><a href="https://api.whatsapp.com/send/?phone=526634631001&text=Welcome+to+Work%40Home+Solutions%2C&type=phone_number&app_absent=0" target="_blank" rel="noopener noreferrer" className="flex items-center hover:text-[#4caf50] transition-colors group"><svg className="w-5 h-5 mr-3 text-[#4caf50] shrink-0 group-hover:opacity-80 transition-opacity" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg> +52 663 436 1001</a></li>
              <li className="flex items-center"><a href="mailto:info@workathomecc.com" className="flex items-center hover:text-[#4caf50] transition-colors group"><svg className="w-5 h-5 mr-3 text-[#4caf50] shrink-0 group-hover:opacity-80 transition-opacity" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg> info@workathomecc.com</a></li>
            </ul>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 mt-12 pt-8 border-t border-blue-800 text-center text-blue-300 text-sm flex flex-col items-center">
          ...
          <p>&copy; 2026 WAH SOLUTIONS LLC. All rights reserved.</p>
        </div>
      </footer>
    </main >
  );
